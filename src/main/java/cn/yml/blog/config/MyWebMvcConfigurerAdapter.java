package cn.yml.blog.config;

import cn.yml.blog.interceptor.BackInterceptor;
import cn.yml.blog.interceptor.ForeInterceptor;
...
public class MyWebMvcConfigurerAdapter extends WebMvcConfigurerAdapter {
     ...
     * 在这里配置后就不需要那么麻烦了，直接访问http://localhost/toLogin就跳转到login.html页面了
     *
     * @param registry
     */
    @Override
